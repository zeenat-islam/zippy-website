<nav class="px-8 py-4 flex items-center justify-between shadow-sm sticky top-0 z-50 bg-white dark:bg-[#010F23]">
    ...
    <ul class="hidden md:flex items-center gap-8 text-sm font-medium" style="color:#94A3BB">
        ...
        <li class="relative flex items-center gap-2 cursor-pointer" onclick="toggleWhatWeDo()">
            ...
            <div id="whatWeDoDropdown" class="absolute hidden bg-white  rounded-2xl shadow-xl z-50 w-[804px] top-[40px] left-0 p-[26px]">
                    ...
                    <div class="flex flex-col w-[368px] gap-[56px] ">
                        ...
                        <div class="flex flex-col w-[330px] gap-[20px]">
                            ...
                            <ul class="flex flex-col gap-2">
                                <li class="text-[#94A3BB] text-[16px] "><a href="#">• Web development</a></li>
                                <li class="text-[#94A3BB] text-[16px]"><a href="#">• App Development</a></li>
                                <li class="text-[#94A3BB] text-[16px]"><a href="#">• Custom Software Development</a></li>
                                <li class="text-[#94A3BB] text-[16px]"><a href="#">• UX/UI Design</a></li>
                            </ul>
                        </div>
                        <div class="flex flex-col w-[330px] gap-[20px]">
                            <h3 class="text-black font-bold text-[16px]">Emerging Technologies</h3>
                            <ul class="flex flex-col gap-2">
                                <li class="text-[#94A3BB] text-[14px]"><a href="#">• Augmented reality</a></li>
                                <li class="text-[#94A3BB] text-[14px]"><a href="#">• Blockchain & Cryptography</a></li>
                            </ul>
                        </div>
                        <div class="flex flex-col w-[330px] gap-[20px]">
                            <h3 class="text-black font-bold text-[16px]">Gaming</h3>
                            <ul class="flex flex-col gap-2 mb-5">
                                <li class="text-[#94A3BB] text-[14px]"><a href="#">• Art & Design</a></li>
                                <li class="text-[#94A3BB] text-[14px]"><a href="#">• Web3</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="w-[1px] bg-[#E5E7EB]"></div>
                    <div class="flex flex-col gap-[26px]">
                        <h3 class="text-black font-bold text-[16px]"><a href="#">Gen AI</a></h3>
                        <h3 class="text-black font-bold text-[16px]"><a href="#">Data Analytics</a></h3>
                        <h3 class="text-black font-bold text-[16px]"><a href="#">Quality Assurance</a></h3>
                        <h3 class="text-black font-bold text-[16px]"><a href="#">Cybersecurity</a></h3>
                        <h3 class="text-black font-bold text-[16px]"><a href="#">SaaS</a></h3>
                        <div class="flex flex-col gap-[20px]">
                            <h3 class="text-black font-bold text-[16px]">E-commerce</h3>
                            <ul class="flex flex-col gap-2">
                                <li class="text-[#94A3BB] text-[14px]"><a href="#">• Design & Development</a></li>
                                <li class="text-[#94A3BB] text-[14px]"><a href="#">• Maintenance & Support</a></li>
                                <li class="text-[#94A3BB] text-[14px]"><a href="#">• Automation & Apps</a></li>
                            </ul>
                        </div>
                        <div class="flex flex-col gap-[20px]">
                            <h3 class="text-black font-bold text-[16px]">Cloud</h3>
                            <ul class="flex flex-col gap-2">
                                <li class="text-[#94A3BB] text-[14px]"><a href="#">• Cloud Application</a></li>
                                <li class="text-[#94A3BB] text-[14px]"><a href="#">• Cloud Ops & Migration</a></li>
                                <li class="text-[#94A3BB] text-[14px]"><a href="#">• Cloud maintenance & integration</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <ul class="flex flex-col text-sm font-medium" style="gap:4px; color:#94A3BB">
                ...
                <div id="mob-whatwedo" style="max-height:0; overflow:hidden; transition:max-height 0.3s ease; padding-left:12px;">
                    <div class="py-2 flex flex-col gap-2">
                        ...
                        <a href="#" class="text-[#94A3BB] text-xs">• Web development</a>
                        <a href="#" class="text-[#94A3BB] text-xs">• App Development</a>
                        <a href="#" class="text-[#94A3BB] text-xs">• Custom Software Development</a>
                        <a href="#" class="text-[#94A3BB] text-xs">• UX/UI Design</a>
                        <p class="text-xs font-bold text-black mt-1">Emerging Technologies</p>
                        <a href="#" class="text-[#94A3BB] text-xs">• Augmented reality</a>
                        <a href="#" class="text-[#94A3BB] text-xs">• Blockchain & Cryptography</a>
                        <p class="text-xs font-bold text-black mt-1">Gaming</p>
                        <a href="#" class="text-[#94A3BB] text-xs">• Art & Design</a>
                        <a href="#" class="text-[#94A3BB] text-xs">• Web3</a>
                        <p class="text-xs font-bold text-black mt-1">More</p>
                        <a href="#" class="text-[#94A3BB] text-xs">• Gen AI</a>
                        <a href="#" class="text-[#94A3BB] text-xs">• Data Analytics</a>
                        <a href="#" class="text-[#94A3BB] text-xs">• Quality Assurance</a>
                        <a href="#" class="text-[#94A3BB] text-xs">• Cybersecurity</a>
                        <a href="#" class="text-[#94A3BB] text-xs">• SaaS</a>
                    </div>
                </div>
                ...
                <li class="px-2 py-2 rounded-lg hover:bg-gray-50">
                    <a href="{{ route('blogs') }}" style="color:inherit; text-decoration:none">Blogs</a>
                </li>
                <li class="px-2 py-2 rounded-lg hover:bg-gray-50">Join Zippy</li>
            </ul>
