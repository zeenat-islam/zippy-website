...
<a href="{{ route('servicesdetail', ['slug' => $slug]) }}" class="no-underline">
<div data-aos="flip-left"
     data-aos-easing="ease-out-cubic"
     data-aos-duration="2000" class="service-card {{ $class }} bg-white dark:bg-[#06254E] flex flex-col rounded-lg p-[14px] w-full lg:w-[407px] shadow-md cursor-pointer hover:shadow-lg transition-shadow duration-300">
    ...
    <div class="flex flex-col gap-3 px-1">
        ...
        <div class="detail-btn flex justify-between h-[54px] dark:bg-[#010F23] w-full items-center pt-1 bg-[#F8F8F8] border rounded-full px-4 py-3 transition no-underline">
